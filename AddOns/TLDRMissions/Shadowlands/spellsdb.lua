...
addon.spellsDB = {
    ...
    [5] = { -- Draven sweeps his wings, dealing $s1 Physical damage to all enemies.
        target = addon.Enums.TargetType.all_enemies,
        type = addon.Enums.spellType.attack,
        attackPercent = 10,
    },
    [6] = { -- Theotar pulses with shadow, dealing $s1 Shadow damage to all enemies at range.
      target = addon.Enums.TargetType.back_enemies,
      type = addon.Enums.spellType.attack,
      attackPercent = 60,
    },
    ...
    [9] = { -- Heal all allies for $s1% of their maximum health.
      target = addon.Enums.TargetType.all_allies,
    ...
    [10] = { -- Smashes the closest enemy for $s1% of their maximum hit points. Each turn, heals for $s3% of maximum health and deals $s2% maximum health Frost damage to all enemies.
      ...
      [3] = {
          type = addon.Enums.spellType.buff,
          target = addon.Enums.TargetType.self,
          duration = 3,
    ...
    [18] = {
        [1] = {
            target = addon.Enums.TargetType.front_enemies,
            type = addon.Enums.spellType.attack,
            attackPercent = 20,
        },
        [2] = {
    ...
    [22] = { -- Ayeleth drains the anima from all adjacent enemies, dealing $s1 Shadow damage and an additional $s2 damage each round.
        [1] = {
            type = addon.Enums.spellType.attack,
            target = addon.Enums.TargetType.cleave_enemies,
            attackPercent = 90,
            affectedByTaunt = true,
        },
        [2] = {
    ...
    [46] = { -- The Phalanx takes 10% reduced damage and protects all ranged allies in the same way.
        ...
        [2] = {
            target = addon.Enums.TargetType.back_allies_exclude_self,
            type = addon.Enums.spellType.buff,
            duration = 1,
            changeDamageTakenPercent = -10,
    ...
    [73] = { -- Molako purifies all enemies in a line, dealing $s1 Holy damage.
        target = addon.Enums.TargetType.line,
        type = addon.Enums.spellType.attack,
        attackPercent = 100,
    },
    ...
    [90] = { -- Niya invigorates adjacent allies, increasing all damage they deal by 20%.
        target = addon.Enums.TargetType.adjacent_allies,
        type = addon.Enums.spellType.passive,
        changeDamageDealtPercent = 20,
    ...
    [97] = { -- Kota unleashes a flurry of arrows, dealing $s1 Physical damage in a cone emanating from her closest enemy.
        target = addon.Enums.TargetType.cone,
        type = addon.Enums.spellType.attack,
        attackPercent = 90,
    },
    ...
    [120] = { -- The Trickster goads a random ally into trying harder.
        target = addon.Enums.TargetType.pseudorandom_followers_only, -- seems to always target bottom right minion on the first turn, after that seems random. targets enemies despite description
        type = addon.Enums.spellType.buff,
        duration = 2,
    ...
    --    type = addon.Enums.spellType.buff,
                target = addon.Enums.TargetType.self,      -- ability seems bugged, never triggered
    --    target = "random_enemy",
    --    attackPercent = 30,
    --    event = "endTurn",
    --    duration = 2,
    ...
    [123] = { -- The Trickster heals front line allies for $s1.
        target = addon.Enums.TargetType.front_allies_only,
        type = addon.Enums.spellType.heal,
        healPercent = 30,
        skipIfFull = true,
    },
    ...
    [125] = { -- The Scavenger lashes out at a random enemy, dealing $s1 Nature damage, and reducing the targets damage by $s2% for one turn.
        [1] = {
            type = addon.Enums.spellType.attack,
            target = addon.Enums.TargetType.pseudorandom_followers_only,
            attackPercent = 60,
            continueIfCasterDies = true,
        },
        [2] = {
    ...
    [166] = { -- Bites at a random enemy, dealing $s1 Shadow damage and healing itself for $s2.
        [1] = {
            target = addon.Enums.TargetType.pseudorandom_enemies_only, -- have only seen logs of it attacking itsself / its own allies.
            type = addon.Enums.spellType.attack,
            attackPercent = 100,
        },
        [2] = {
    ...
    [167] = { -- Casts a series of sharp, stone, shards at all enemies at range, dealing $s1 Nature damage.
        target = addon.Enums.TargetType.furthest_enemy, -- despite description, seems to only hit furthest enemy
        type = addon.Enums.spellType.attack,
        attackPercent = 150,
    },
    ...
    [171] = { -- Hurls a massive boulder, dealing $s1 Nature damage to all enemies at range.
        target = addon.Enums.TargetType.furthest_enemy, -- despite description, only hit one target. Callous Peacekeeper[10][855HP] cast Pitched Boulder at Ardenweald Grovetender[1][1058HP] for 122 Nature damage.
        type = addon.Enums.spellType.attack,
        attackPercent = 100,
    },
    ...
    [175] = { -- The party animal is lost in the moment and lashes out at a random target, dealing $s1 Shadow damage.
        target = addon.Enums.TargetType.pseudorandom_everything,
        type = addon.Enums.spellType.attack,
        attackPercent = 120,
    },
    ...
    [207] = { -- Lunges into their foes with tooth and claw, dealing $s1 damage to all enemies in a line.
        target = addon.Enums.TargetType.closest_enemy, -- despite the description, seems to only hit closest enemy
        type = addon.Enums.spellType.attack,
        attackPercent = 30,
    },
    ...
    [209] = { -- Inspires a random ally to greater sacrifice. Buffing their damage by $s1% for one turn.
        target = addon.Enums.TargetType.pseudorandom_enemies_only,
        type = addon.Enums.spellType.buff,
        duration = 1,
        changeDamageDealtPercent = 50,
    ...
    [265] = { -- Toxic claws tear in a line from the closest enemy, dealing $s1 Nature damage.
        target = addon.Enums.TargetType.closest_enemy, -- despite description, doesn't seem to actually attack in a line. closest enemy only
        type = addon.Enums.spellType.attack,
        attackPercent = 100,
    },
 ...
 -- yup, this actually keeps doing damage after the caster dies. Wow. Ardenweald Grovetender[3][548HP] killed Boneweave Ambusher[9][275HP]., Boneweave Ambusher[9][275HP]'s Ambush dealt 158 Nature to Ardenweald Grovetender[3][548HP]. Boneweave Ambusher[9][0HP]'s Ambush dealt 158 Nature to Ardenweald Grovetender[3][390HP].
    ...
    [283] = { -- Claws laden with Anima tear in a line from the closest enemy, dealing $s1 Arcane damage.
        target = addon.Enums.TargetType.closest_enemy, -- despite the description, doesn't seem to actually attack in a line
        type = addon.Enums.spellType.attack,
        attackPercent = 75,
    },
    ...
    [324] = { -- Heals all adjacent allies for $s1.
        target = addon.Enums.TargetType.adjacent_allies_or_all_allies,
        type = addon.Enums.spellType.heal,
        healPercent = 120,
        skipIfFull = true,
    },
    ...
    [336] = { -- Heal an adjacent ally for $s1.
        target = addon.Enums.TargetType.nearby_ally_or_self, -- unsure if this spell just behaves differently or do all "cloest_ally" spells behave like this. will treat it as a special case until further info is known
        type = addon.Enums.spellType.heal,
        healPercent = 80,
        skipIfFull = true,
    },
